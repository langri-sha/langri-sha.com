...
provider "registry.terraform.io/hashicorp/google" {
  version     = "7.43.0"
  constraints = ">= 3.33.0, >= 3.43.0, >= 3.64.0, >= 3.83.0, >= 4.25.0, >= 4.28.0, >= 4.64.0, >= 5.41.0, >= 6.19.0, 7.43.0, < 8.0.0"
  hashes = [
...
provider "registry.terraform.io/hashicorp/google-beta" {
  version     = "7.42.0"
  constraints = ">= 3.43.0, >= 3.64.0, >= 4.11.0, >= 4.64.0, >= 5.41.0, >= 6.19.0, 7.42.0, < 8.0.0"
  hashes = [
