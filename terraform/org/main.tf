...
module "org" {
  source = "github.com/langri-sha/terraform-google-cloud-platform//modules/org?ref=v0.8.0"
...
module "terraform_admin" {
  source = "github.com/langri-sha/terraform-google-cloud-platform//modules/terraform-admin?ref=v0.8.0"
...
module "public_dns" {
  source = "github.com/langri-sha/terraform-google-cloud-platform//modules/public-dns?ref=v0.8.0"
...
module "web" {
  source = "github.com/langri-sha/terraform-google-cloud-platform//modules/workspace?ref=v0.8.0"
