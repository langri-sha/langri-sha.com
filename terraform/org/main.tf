...
module "org" {
  source = "github.com/langri-sha/terraform-google-cloud-platform//modules/org?ref=v0.11.0"
...
module "terraform_admin" {
  source = "github.com/langri-sha/terraform-google-cloud-platform//modules/terraform-admin?ref=v0.11.0"
...
module "public_dns" {
  source = "github.com/langri-sha/terraform-google-cloud-platform//modules/public-dns?ref=v0.11.0"
