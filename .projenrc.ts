...
project.package?.addField('packageManager', 'pnpm@9.7.0')
...
project.addSubproject(
  {
    ...
    package: {
      ...
      devDeps: ['@langri-sha/babel-test@workspace:*', '@types/node@20.14.14'],
...
project.addSubproject(
  {
    ...
    package: {
      ...
      devDeps: ['@types/debug@4.1.12', 'prettier@3.3.3', 'projen@0.86.5'],
      peerDeps: ['projen@^0.86.0'],
    },
  },
  subproject,
...
project.addSubproject(
  {
    ...
    package: {
      ...
      devDeps: ['@langri-sha/babel-preset@workspace:*', '@types/node@20.14.14'],
