...
project.addSubproject(
  {
    ...
    package: {
      ...
      devDeps: ['@langri-sha/babel-test@workspace:*', '@types/node@20.19.20'],
...
project.addSubproject(
  {
    ...
    package: {
      ...
      copyrightYear: '2024',
      type: 'module',
      peerDeps: ['beachball@^2.0.0', 'projen@^0.99.0'],
    },
  },
  subproject,
  test,
...
project.addSubproject(
  {
    ...
    package: {
      ...
      deps: ['serialize-javascript@6.0.2'],
      devDeps: ['@types/serialize-javascript@5.0.4'],
      peerDeps: ['eslint@^9.0.0', 'projen@^0.99.0'],
    },
  },
  subproject,
  test,
...
project.addSubproject(
  {
    ...
    package: {
      ...
      copyrightYear: '2024',
      devDeps: ['@types/node@20.19.20'],
      peerDeps: ['husky@^9.0.1', 'projen@^0.99.0'],
    },
  },
  subproject,
  test,
...
project.addSubproject(
  {
    ...
    package: {
      ...
      deps: ['serialize-javascript@6.0.2'],
      devDeps: ['@types/serialize-javascript@5.0.4'],
      peerDeps: ['jest@^28.00 || ^29.00', 'projen@^0.99.0'],
    },
  },
  subproject,
  test,
...
project.addSubproject(
  {
    ...
    package: {
      ...
      devDeps: ['@types/debug@4.1.12', 'prettier@3.3.3', 'projen@0.99.8'],
      peerDeps: ['projen@^0.99.0'],
    },
  },
  subproject,
...
project.addSubproject(
  {
    ...
    package: {
      ...
      deps: ['serialize-javascript@6.0.2'],
      devDeps: ['@types/serialize-javascript@5.0.4'],
      peerDeps: ['lint-staged@^15.0.0', 'projen@^0.99.0'],
    },
  },
  subproject,
  test,
...
project.addSubproject(
  {
    ...
    package: {
      ...
      deps: ['serialize-javascript@6.0.2'],
      devDeps: ['@types/serialize-javascript@5.0.4'],
      peerDeps: ['prettier@^3.0.0', 'projen@^0.99.0'],
    },
  },
  subproject,
  test,
...
project.addSubproject(
  {
    ...
    package: {
      ...
      type: 'module',
      devDeps: ['@langri-sha/schemastore-to-typescript@workspace:*'],
      peerDeps: ['projen@^0.99.0', '@swc/core@^1.6.0'],
    },
  },
  subproject,
  test,
...
project.addSubproject(
  {
    ...
    package: {
      ...
      devDeps: ['@langri-sha/babel-preset@workspace:*', '@types/node@20.19.20'],
