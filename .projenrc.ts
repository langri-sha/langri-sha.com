...
project.addSubproject(
  {
    ...
    package: {
      ...
      devDeps: ['@langri-sha/babel-test@workspace:*', '@types/node@20.14.11'],
...
project.addSubproject(
  {
    ...
    package: {
      ...
      copyrightYear: '2024',
      type: 'module',
      deps: ['debug@4.3.5', 'execa@8.0.1', 'minimatch@10.0.1'],
      devDeps: ['@types/debug@4.1.12', 'prettier@3.3.3', 'projen@0.82.4'],
      peerDeps: ['projen@^0.82.0'],
    },
  },
  subproject,
...
project.addSubproject(
  {
    ...
    package: {
      ...
      type: 'module',
      devDeps: ['@langri-sha/schemastore-to-typescript@workspace:*'],
      peerDeps: ['projen@^0.82.0', '@swc/core@^1.6.0'],
    },
  },
  subproject,
  test,
...
project.addSubproject(
  {
    ...
    package: {
      ...
      devDeps: ['@langri-sha/babel-preset@workspace:*', '@types/node@20.14.11'],
