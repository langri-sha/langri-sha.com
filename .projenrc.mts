...
project.package?.addField('packageManager', 'pnpm@9.4.0')
...
project.addSubproject(
  {
    ...
    package: {
      ...
      devDeps: ['@langri-sha/babel-test@workspace:*', '@types/node@20.14.3'],
...
project.addSubproject(
  {
    ...
    package: {
      ...
      devDeps: ['@types/debug@4.1.12', 'prettier@3.3.2', 'projen@0.82.6'],
      peerDeps: ['projen@^0.82.0'],
    },
  },
  subproject,
...
project.addSubproject(
  {
    ...
    package: {
      ...
      devDeps: ['@langri-sha/babel-preset@workspace:*', '@types/node@20.14.3'],
