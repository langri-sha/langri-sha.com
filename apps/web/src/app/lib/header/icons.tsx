import { type PropsOf, css } from '@emotion/react'
...
export const Docker: React.FC<{ className?: string }> = styled(
  (props: PropsOf<typeof Docker>) => (
    <svg
...
export const Github: React.FC<{ className?: string }> = styled(
  ({ className }: PropsOf<typeof Github>) => (
    <svg
      className={className}
      xmlns="http://www.w3.org/2000/svg"
      viewBox="0 0 32 32"
...
export const Twitter: React.FC<{ className?: string }> = styled(
...
export const Npm: React.FC<{ className?: string }> = styled(
  ({ className }: PropsOf<typeof Twitter>) => (
    <svg
      className={className}
      xmlns="http://www.w3.org/2000/svg"
...
export const Stackoverflow: React.FC<{ className?: string }> = styled(
  ({ className }: PropsOf<typeof Twitter>) => (
    <svg
      className={className}
      xmlns="http://www.w3.org/2000/svg"
